...
Developed an understanding of the find command

## My solve

**Flag:** pwn.college{UA7L-u_dn6KHiayy5mwJbujGulr.QXyMDO0wiN3gjNzEzW}

What I Learnt: Understood the working of the find command

- Used the find command with the -name argument to find all the files having flag in them and then individually read them out using cat to get the flag
...
/opt/busybox/busybox-1.33.2/networking/libiproute/flag
...
.  ..  __init__.py  __pycache__  flag.py
hacker@commands~finding-files:/usr/local/lib/python3.8/dist-packages/pwnlib/flag$ cat __pycache__
cat: __pycache__: Is a directory
hacker@commands~finding-files:/usr/local/lib/python3.8/dist-packages/pwnlib/flag$ cd /opt/busybox/busybox-1.33.2/networking/libiproute/flag
bash: cd: /opt/busybox/busybox-1.33.2/networking/libiproute/flag: Not a directory
hacker@commands~finding-files:/usr/local/lib/python3.8/dist-packages/pwnlib/flag$ cat /opt/busybox/busybox-1.33.2/networking/libiproute/flag
pwn.college{UA7L-u_dn6KHiayy5mwJbujGulr.QXyMDO0wiN3gjNzEzW}
```
